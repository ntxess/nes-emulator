...
impl InstructionSet {
    ...
    fn bit(&self, cpu: &mut CPU) {
        ...
        cpu.set_status_flags((address & StatusFlags::OVERFLOW.bits() as u16) != 0, StatusFlags::OVERFLOW);
        cpu.set_status_flags((address & StatusFlags::NEGATIVE.bits() as u16) != 0, StatusFlags::NEGATIVE);
    }
